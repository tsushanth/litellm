...
class TestAzureAnthropicConfig:
    ...
    def test_output_config_stripped_from_request(self):
        """Azure AI Foundry rejects ``output_config`` with 400; verify it is dropped."""
        config = AzureAnthropicConfig()
    ...
    def test_output_config_stripped_regardless_of_source(self):
        """``output_config`` is always stripped from the final request regardless of how it was set."""
        config = AzureAnthropicConfig()
